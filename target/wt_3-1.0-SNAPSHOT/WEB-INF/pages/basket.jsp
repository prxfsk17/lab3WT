            ...
            <div class='basket-item-container'>
                ...
                <div class='basket-item-info'>
                    ...
                    <div class='basket-item-price-wrap'>
                        <p class='basket-item-price'><fmt:message key="basket.price"/>
                            <span>${dishInfo.dish.price*dishInfo.amount}</span> <fmt:message key="basket.currency"/></p>
